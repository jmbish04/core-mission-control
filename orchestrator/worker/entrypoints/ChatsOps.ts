...
export class ChatsOps extends BaseWorkerEntrypoint<CoreEnv> {
    ...
    async updateConversationLog(params: {
        ...
        if (params.structuredData !== undefined) updateData.structuredData = params.structuredData;
        if (params.websocketSent !== undefined) updateData.websocketSent = params.websocketSent;
