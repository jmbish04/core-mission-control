...
export class DataOps extends BaseWorkerEntrypoint<CoreEnv> {
    ...
    async updateApp(params: {
        ...
        if (params.finalPrompt !== undefined) updateData.finalPrompt = params.finalPrompt;
        if (params.framework !== undefined) updateData.framework = params.framework;
        if (params.status !== undefined) updateData.status = params.status;
        if (params.deploymentId !== undefined) updateData.deploymentId = params.deploymentId;
        if (params.githubRepositoryUrl !== undefined) updateData.githubRepositoryUrl = params.githubRepositoryUrl;
        if (params.githubRepositoryVisibility !== undefined) updateData.githubRepositoryVisibility = params.githubRepositoryVisibility;
    ...
    async updateUser(params: {
        ...
        if (params.emailVerified !== undefined) updateData.emailVerified = params.emailVerified;
        if (params.isActive !== undefined) updateData.isActive = params.isActive;
        if (params.isSuspended !== undefined) updateData.isSuspended = params.isSuspended;
    ...
    async updateUserSecret(params: {
        ...
        if (params.encryptedValue !== undefined) updateData.encryptedValue = params.encryptedValue;
        if (params.keyPreview !== undefined) updateData.keyPreview = params.keyPreview;
        if (params.description !== undefined) updateData.description = params.description;
        if (params.isActive !== undefined) updateData.isActive = params.isActive;
    ...
    async updateUserModelProvider(params: {
        ...
        if (params.name !== undefined) updateData.name = params.name;
        if (params.baseUrl !== undefined) updateData.baseUrl = params.baseUrl;
        if (params.secretId !== undefined) updateData.secretId = params.secretId;
        if (params.isActive !== undefined) updateData.isActive = params.isActive;
    ...
    async createOAuthState(params: {
        ...
        return {
            id: oauthState.id,
            createdAt: oauthState.createdAt ?? Date.now(),
        };
    }
